...
// marks:  is an array of any numbers of members
//         wich are integer numbers referencing the indexes of bytes
//         wich will be highlighted in the output.
//         if not specified, default is an empty array.
//         This array is used in the "html" output mode only.
//
...
function hexview(bytes = [], offset = 0x0, format = "text", marks = []) {
  ...
  switch (format.toLowerCase()) {
    case "html":
      space = "&nbsp;";
      cr = "<br>\n";
      colorStart = '<span class="bg-black text-white" >';
      colorEnd = '</span>';
